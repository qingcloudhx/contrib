...
[![Build Status](https://travis-ci.org/qingcloudhx/contrib.svg?branch=master)](https://travis-ci.org/qingcloudhx/contrib.svg?branch=master)
...
```bash
flogo install github.com/qingcloudhx/contrib/function/string
```
...
New activities, triggers and functions are welcomed. If you would like to contribute, please following the [contribution guidelines](https://github.com/TIBCOSoftware/flogo/blob/master/CONTRIBUTING.md). If you have any questions, issues, etc feel free to chat with us on [Gitter](https://gitter.im/qingcloudhx/Lobby?utm_source=share-link&utm_medium=link&utm_campaign=share-link).

## License
The contrib repository is licensed under a BSD-type license. See [LICENSE](LICENSE) for license text.

### Support
For Q&A you can post your questions on [Gitter](https://gitter.im/qingcloudhx/Lobby?utm_source=share-link&utm_medium=link&utm_campaign=share-link)
